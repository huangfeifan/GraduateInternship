/*
    pybindLib/detail/common.h -- Basic macros
...
// the main `pybindLib` namespace.
#if !defined(PYBIND11_NAMESPACE)
#  ifdef __GNUG__
#    define PYBIND11_NAMESPACE pybindLib __attribute__((visibility("hidden")))
#  else
...
#    error pybindLib requires Intel C++ compiler v18 or newer
#  elif __INTEL_COMPILER < 1900 && defined(PYBIND11_CPP14)
#    error pybindLib supports only C++11 with Intel C++ compiler v18. Use v19 or newer for C++14.
#  endif
...
#    error pybindLib requires clang 3.3 or newer
#  endif
#elif defined(__clang__)
// Apple changes clang version macros to its Xcode version; the first Xcode release based on
// (upstream) clang 3.3 was Xcode 5:
#  if __clang_major__ < 5
#    error pybindLib requires Xcode/clang 5.0 or newer
#  endif
#elif defined(__GNUG__)
#  if __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 8)
#    error pybindLib requires gcc 4.8 or newer
#  endif
#elif defined(_MSC_VER)
// Pybind hits various compiler bugs in 2015u2 and earlier, and also makes use of some stl features
// (e.g. std::negation) added in 2015u3:
#  if _MSC_FULL_VER < 190024210
#    error pybindLib requires MSVC 2015 update 3 or newer
#  endif
#endif
...
// the default under pybindLib/tests).
...
// If DEFINED, pybindLib::str can hold PyUnicodeObject or PyBytesObject
//             (probably surprising and never documented, but this was the
//             legacy behavior until and including v2.6.x). As a side-effect,
//             pybindLib::isinstance<str>() is true for both pybindLib::str and
//             pybindLib::bytes.
// If UNDEFINED, pybindLib::str can only hold PyUnicodeObject, and
//               pybindLib::isinstance<str>() is true only for pybindLib::str.
//               However, for Python 2 only (!), the pybindLib::str caster
...
#define PYBIND11_STR_TYPE ::pybindLib::bytes
...
#define PYBIND11_CATCH_INIT_EXCEPTIONS \
        catch (pybindLib::error_already_set &e) {                               \
            PyErr_SetString(PyExc_ImportError, e.what());                      \
            return nullptr;                                                    \
        } catch (const std::exception &e) {                                    \
            PyErr_SetString(PyExc_ImportError, e.what());                      \
    ...
    ***Deprecated in favor of PYBIND11_MODULE***
    ...
    .. code-block:: cpp
        ...
        PYBIND11_PLUGIN(example) {
            pybindLib::module_ m("example", "pybindLib example plugin");
...
/** \rst
    ...
    .. code-block:: cpp
        ...
        PYBIND11_MODULE(example, m) {
            m.doc() = "pybindLib example module";
...
enum class return_value_policy : uint8_t {
    ...
    /** This policy only applies to methods and properties. It references the
        ...
        pybindLib then couples the lifetime of the parent to the child via a
...
static_assert(std::is_standard_layout<instance>::value, "Internal error: `pybindLib::detail::instance` is not standard layout!");
...
PYBIND11_RUNTIME_EXCEPTION(cast_error, PyExc_RuntimeError) /// Thrown when pybindLib::cast or handle::call fail due to a type casting error
...
template <typename... Args> struct overload_cast {
    static_assert(detail::deferred_t<std::false_type, Args...>::value,
                  "pybindLib::overload_cast<...> requires compiling in C++14 mode");
};
#endif // overload_cast
