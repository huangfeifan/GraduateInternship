/*
    pybindLib/attr.h: Infrastructure for processing custom
...
struct metaclass {
    ...
    /// Override pybindLib's default metaclass
...
/// work with later versions of pybindLib.  You may wish to consult the
...
template <> struct process_attribute<pos_only> : process_attribute_default<pos_only> {
    static void init(const pos_only &, function_record *r) {
        ...
        if (r->nargs_pos_only > r->nargs_pos)
            ...
            // It also can't follow a kw_only, but a static_assert in pybindLib.h checks that
    }
};
