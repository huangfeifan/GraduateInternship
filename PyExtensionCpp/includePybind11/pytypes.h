/*
    pybindLib/pytypes.h: Convenience wrapper classes for basic Python types
...
// through pybindLib::cast(obj) to convert it to an `object`.
...
public:
    ...
    PYBIND11_DEPRECATED("Use of obj.attr(...) as bool is deprecated in favor of pybindLib::hasattr(obj, ...)")
...
public:
    ...
    // Defined in pybindLib/cast.h
    /// Convert C++ type to handle if previously registered. Does not convert
    /// standard types, like int, float. etc. yet.
    /// See https://github.com/pybind/pybindLib/issues/2486
    template<typename T>
