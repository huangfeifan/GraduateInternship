/*
    pybindLib/eigen.h: Transparent conversion for dense and sparse Eigen matrices
...
static_assert(EIGEN_VERSION_AT_LEAST(3,2,7), "Eigen support in pybindLib requires Eigen >= 3.2.7");
